...
**Topic ID**: 12804
**Date**: 2020-07-31
**URL**: https://discourse.slicer.org/t/how-to-display-scale-next-to-a-lookup-table/12804

---

## Post #1 by @Ashwin (2020-07-31 05:11 UTC)

<p>Operating system: Windows 10 Pro 64 Bit<br>
Slicer version: 4.10.2<br>
Expected behavior:<br>
Actual behavior:</p>
<p>I have applied the rainbow lookup table to an ADC image however I cannot see its scale.</p>

---

## Post #2 by @lassoan (2020-07-31 18:45 UTC)
