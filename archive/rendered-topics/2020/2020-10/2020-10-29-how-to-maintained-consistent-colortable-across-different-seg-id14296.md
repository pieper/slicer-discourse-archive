...
<p>In step 2, we have 3 classes, but there might only be one class, so the user would only add one class, and set the proper class name. I think that’s why we got an inconsistent color table. Any suggestions to improve this workflow?</p>
