...
**Topic ID**: 679
**Date**: 2017-07-12
**URL**: https://discourse.slicer.org/t/having-trouble-generating-3d-model/679

---

## Post #1 by @Haam (2017-07-12 14:30 UTC)

<p>Thank you all for this great software and great forum<br>
I am having trouble generating STL model from CT scan.<br>
Once I upload the CT scan, I go to volume rendering and choose Bone as a preset tool. However, it worked only once with me after that I can’t do it again. I can not have a 3D model to crop from a 3D model</p>
<p>Could anyone please help me with this?</p>
<p>Thanks</p>

---

## Post #2 by @ihnorton (2017-07-12 14:33 UTC)
