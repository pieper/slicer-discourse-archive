...
**Topic ID**: 20534
**Date**: 2021-11-08
**URL**: https://discourse.slicer.org/t/reminder-project-week-36-prep-meetings-start-tomorrow-nov-9th/20534

---

## Post #1 by @Sam_Horvath (2021-11-08 17:30 UTC)

<p>Dear members of the Project Week community,</p>
<p>We are happy to announce the beginning of preparation meetings for the next project week (Jan 17-21, 2022). Weekly meetings will start on Nov 9th, 2021 (10 am Boston time, EDT) on Zoom. You can join using the following link which will remain the same for all preparation meetings:</p>
