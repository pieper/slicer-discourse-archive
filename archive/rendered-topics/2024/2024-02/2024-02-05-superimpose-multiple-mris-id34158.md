...
**Topic ID**: 34158
**Date**: 2024-02-05
**URL**: https://discourse.slicer.org/t/superimpose-multiple-mris/34158

---

## Post #1 by @Vittorio (2024-02-05 22:26 UTC)

<p>I have a problem because I can’t superimpose multiple MRIs.<br>
I’m trying to reconstruct a 3D model of my brain but I have a problem.<br>
I have selected 3 scans with the best resolution but I have to merge them because, for each plane, there is a scan with a higher resolution.<br>
The optimal scan for the frontal plane is the first, for the horizontal plane the second and for the lateral plane the third.</p>
<p>How do I make the program use the scan I prefer only for a specific plan and not for all three?</p>

---

## Post #2 by @pieper (2024-02-05 22:41 UTC)

<p>This question comes up from time to time.  These links should give you some ideas:</p>
