...
**Topic ID**: 35788
**Date**: 2024-04-29
**URL**: https://discourse.slicer.org/t/pulmonary-vessels-segmentation-with-monai/35788

---

## Post #1 by @Killmaro (2024-04-29 05:42 UTC)

<p>Hi All</p>
<p>By selecting MONAI’s automatic segmentation “lung” tool I obtain this result, which is rather satisfactory, however there is significant aliasing. Is there a way to modify the sampling settings to obtain a model with better spatial resolution (without using smoothing)? Can the quality of the CT angiogram also help to improve this point?</p>
