...
last_bumped: 2026-07-01T14:40:13.673Z
---
...
## Post #15 by @douglas (2026-07-01 14:38 UTC)

<p>Hello.</p>
<p>I would like to take this opportunity to ask for help. I also have files created by GE CtScan (vgl).</p>
<p>When the scans are small (all files in one folder), the 3D Slicer works very well with the extension you created. However, one of the files is especially large (the object was also large). The CT scan program divided the object into 4 parts (folders). See the image:</p>
<p><div class="lightbox-wrapper"><a class="lightbox" href="https://us1.discourse-cdn.com/flex002/uploads/slicer/original/3X/a/5/a5a52d27a94f3d8603c31da3ecddacff9d549f7b.png" data-download-href="/uploads/short-url/nDmFCRoGIgSA1W3SRo9RTxCk8D9.png?dl=1" title="image" rel="noopener nofollow ugc"><img src="https://us1.discourse-cdn.com/flex002/uploads/slicer/optimized/3X/a/5/a5a52d27a94f3d8603c31da3ecddacff9d549f7b_2_690x232.png" alt="image" data-base62-sha1="nDmFCRoGIgSA1W3SRo9RTxCk8D9" width="690" height="232" srcset="https://us1.discourse-cdn.com/flex002/uploads/slicer/optimized/3X/a/5/a5a52d27a94f3d8603c31da3ecddacff9d549f7b_2_690x232.png, https://us1.discourse-cdn.com/flex002/uploads/slicer/optimized/3X/a/5/a5a52d27a94f3d8603c31da3ecddacff9d549f7b_2_1035x348.png 1.5x, https://us1.discourse-cdn.com/flex002/uploads/slicer/original/3X/a/5/a5a52d27a94f3d8603c31da3ecddacff9d549f7b.png 2x" data-dominant-color="F9F9F9"><div class="meta"><svg class="fa d-icon d-icon-far-image svg-icon" aria-hidden="true"><use href="#far-image"></use></svg><span class="filename">image</span><span class="informations">1174×396 45.2 KB</span><svg class="fa d-icon d-icon-discourse-expand svg-icon" aria-hidden="true"><use href="#discourse-expand"></use></svg></div></a></div></p>
<p>In this format, I can’t open the entire file, and when I do, it only opens part of the object. I believe the solution is to unify the files into a single folder. Any suggestions? Thank you!</p>

---

## Post #16 by @muratmaga (2026-07-01 14:40 UTC)

<p>We don’t have GE scanner and not have access to those files. So I can’t really do much beyond suggesting to upload the source code of GEVolImport as is, and that specific multi-part pcr file and ask one of the LLMs models how to fix it.</p>
