...
date: 2026-07-27
url: https://discourse.slicer.org/t/47748
last_bumped: 2026-07-27T17:05:12.090Z
---
...
**Topic ID**: 47748
**Date**: 2026-07-27
**URL**: https://discourse.slicer.org/t/3d-slicer-cannot-display-cardiac-lge-mri-volume-correctly-only-a-single-line-slice-is-shown-after-dicom-import/47748

---

## Post #1 by @yennys (2026-07-27 11:27 UTC)
...
## Post #2 by @pieper (2026-07-27 17:05 UTC)

<p>You can try enabling advanced mode and selecting on of the other plugins if the default selection is not working.</p>
<p>You can also try the ideas here: <a href="https://slicer.readthedocs.io/en/latest/user_guide/modules/dicom.html#troubleshooting">https://slicer.readthedocs.io/en/latest/user_guide/modules/dicom.html#troubleshooting</a></p>
<p>If you are able to share the data probably someone can help you figure it out.</p>
