...
**Topic ID**: 26484
**Date**: 2022-11-29
**URL**: https://discourse.slicer.org/t/na-mic-project-week-project-week-38-prep-meetings-start-this-tuesday-nov-29th/26484

---

## Post #1 by @Sam_Horvath (2022-11-29 02:57 UTC)

<p>Dear Project Week community,</p>
<p>We are happy to announce the beginning of preparation meetings for the next project week (Jan 27- Feb 3, 2023). Weekly meetings will start on Nov 29th, 2022 (10 am Boston time, EDT) on Zoom. You can join using the following link which will remain the same for all preparation meetings:</p>
