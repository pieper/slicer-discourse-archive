...
**Topic ID**: 5874
**Date**: 2019-02-21
**URL**: https://discourse.slicer.org/t/points-interaction-between-segment-node-and-model-node/5874

---

## Post #1 by @SebastianE93 (2019-02-21 20:11 UTC)
...
## Post #2 by @cpinter (2019-02-25 16:29 UTC)

<p>A post was merged into an existing topic: <a href="/t/points-and-surface-interaction-between-segment-node-and-model-node/5921">Points and surface interaction between segment node and model node</a></p>

---

## Post #3 by @cpinter (2019-02-25 16:29 UTC)
