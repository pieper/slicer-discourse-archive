...
date: 2019-01-30
url: https://discourse.slicer.org/t/5580
---
...
**Topic ID**: 5580
**Date**: 2019-01-30
**URL**: https://discourse.slicer.org/t/could-not-load-dicom/5580
...
<p>Hi!<br>
I get the following error when trying to load DICOMs from SPECT and from CT: “3d slicer could not load as a scalar volume”.<br>
I have checked the DICOM tag, but can not see that anything is missing. The tag is copied below. Any ideas about what could be wrong?</p>

---

## Post #2 by @alide (2019-01-30 15:55 UTC)
...
## Post #3 by @lassoan (2019-01-31 00:18 UTC)

<p>Is any error written into the application log? (menu: Help / Report a bug)</p>

---

## Post #4 by @alide (2019-01-31 06:37 UTC)

<p>Dear Andras Lasso,</p>
<p>Thank you very much for your response. After sending the request I have resolved the issue myself. The trouble was that<br>
the files did not have an entry in the Accession Number tag.</p>
<p>Best regards,</p>
